 ...
 *
 * The byte arrays below are generated, not transcribed. tools/gen_vectors.py
 * emits them as c_arrays.txt, byte-identical
 * to the hex files under extras/golden/ (lowercase hex, 32 bytes/line, LF
 * endings — strip whitespace and hex-decode to reproduce them). The
 * generator round-trips every vector through imud's own reference Python
 * client before writing, so these cannot drift from the daemon; regenerate
...
/* ─────────────────────────────────────────────────────────────────────────
 * Golden vectors (extras/golden/, generated by tools/gen_vectors.py)
 * ───────────────────────────────────────────────────────────────────────*/

static const uint8_t kValidPacket[276] = {
    0x44, 0x55, 0x4d, 0x49, 0x11, 0x00, 0x3d, 0x1c, 0x15, 0x4d, 0x9e, 0x5a,
    ...
    0x00, 0x00, 0x00, 0x3c, 0x00, 0x00, 0x80, 0x3f, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x70, 0x3f, 0x00, 0x00, 0x88, 0x3f, 0x75, 0x85, 0xff, 0xc9,
};

static const uint8_t kBadCrcPacket[276] = {
    0x44, 0x55, 0x4d, 0x49, 0x11, 0x00, 0x3d, 0x1c, 0x15, 0x4d, 0x9e, 0x5a,
    0x36, 0xe8, 0x53, 0x18, 0x15, 0x7f, 0xfd, 0xf7, 0x3e, 0xe8, 0x53, 0x18,
    0x80, 0x1a, 0x06, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3e,
    0x00, 0x00, 0x80, 0xbe, 0x00, 0x00, 0x1d, 0xc1, 0x00, 0x00, 0x20, 0x3e,
    ...
    0x00, 0x00, 0xa8, 0x40, 0x00, 0x00, 0x40, 0x3d, 0x00, 0x00, 0x80, 0x3c,
    0x00, 0x00, 0x00, 0x3c, 0x00, 0x00, 0x80, 0x3f, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x70, 0x3f, 0x00, 0x00, 0x88, 0x3f, 0x75, 0x85, 0xff, 0x36,
};

static const uint8_t kResyncStream[573] = {
    0xde, 0xad, 0xbe, 0xef, 0x00, 0x11, 0x22, 0x44, 0x55, 0x4d, 0x49, 0x11,
    0x00, 0x99, 0x88, 0x77, 0x66, 0x55, 0x44, 0x33, 0x22, 0x44, 0x55, 0x4d,
    0x49, 0x11, 0x00, 0x3d, 0x1c, 0x15, 0x4d, 0x9e, 0x5a, 0x36, 0xe8, 0x53,
    ...
    0x3c, 0x00, 0x00, 0x80, 0x3f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x70,
    0x3f, 0x00, 0x00, 0x88, 0x3f, 0xda, 0x5c, 0x0d, 0xb0, 0x44, 0x55, 0x4d,
    0x49, 0x11, 0x00, 0x3d, 0x1c, 0x95, 0xe3, 0x36, 0x5b, 0x36, 0xe8, 0x53,
    0x18, 0x15, 0x7f, 0xfd, 0xf7, 0x3e, 0xe8, 0x53, 0x18, 0x80, 0x1a, 0x06,
    0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3e, 0x00, 0x00, 0x80,
    0xbe, 0x00, 0x00, 0x1d, 0xc1, 0x00, 0x00, 0x20, 0x3e, 0x00, 0x00, 0x90,
    0xbe, 0x00, 0x80, 0x1d, 0xc1, 0x00, 0x00, 0x40, 0x3c, 0x00, 0x00, 0xc0,
    ...
    ,
    ...
    0x40, 0x00, 0x00, 0x40, 0x3d, 0x00, 0x00, 0x80, 0x3c, 0x00, 0x00, 0x00,
    0x3c, 0x00, 0x00, 0x80, 0x3f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x70,
    0x3f, 0x00, 0x00, 0x88, 0x3f, 0x8a, 0xa2, 0x1a, 0x88,
};
...
static void assertValidPacketFields(const imud_packet_t &p) {
    ...
    TEST_ASSERT_EQUAL_UINT16(17, p.version);
    ...
    /* v17 MEKF gate health / NIS. innov_weight 1.0 + innov_reject 0.0 is
     * the healthy case (cap never fired, nothing gate-rejected); the NIS
     * pair straddles 1.0, the covariance-consistent value. */
    assertFloatField(1.0f, p.innov_weight);
    assertFloatField(0.0f, p.innov_reject);
    assertFloatField(0.9375f, p.nis_accel);
    assertFloatField(1.0625f, p.nis_mag);

    TEST_ASSERT_EQUAL_UINT32(3388966261u, p.crc32);
    TEST_ASSERT_EQUAL_UINT32(0xC9FF8575u, p.crc32);
...
static void test_version_mismatch_rejected(void) {
    ...
    pkt[4] = 14;  /* version LSB: 17 -> 14, the previous wire version */
...
static void test_struct_size_and_crc_offset(void) {
    TEST_ASSERT_EQUAL_UINT32(276, sizeof(imud_packet_t));
    TEST_ASSERT_EQUAL_UINT32(IMUD_PACKET_SIZE, sizeof(imud_packet_t));
    TEST_ASSERT_EQUAL_UINT32(272, offsetof(imud_packet_t, crc32));
}
